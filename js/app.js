...
function keepItSecretKeepItSafe() {
  ...
  secretDiv.classList.add('magic-imbued-jewelry');
  // add the ring as a child of `Frodo`
  document.querySelectorAll('.hobbit')[0].appendChild(secretDiv);
}
...
function makeBaddies() {
  ...
  for (let baddy of baddies) {
    ...
    baddyLi.innerText = baddy;
    baddiesList.appendChild(baddyLi);
  }
...
function makeBuddies() {
  ...
  buddiesList.appendChild(asideEl);
...
function beautifulStranger() {
  ...
  document.querySelector("#rivendell ul").children[4].innerHTML = "Aragorn";
}
...
function forgeTheFellowShip() {
  ...
  const buddies = document.querySelectorAll('#rivendell ul li');
